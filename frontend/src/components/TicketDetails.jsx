...
const TicketDetails = ({ ticket, onClose, onUpdate }) => {
    ...
    const handleAddNote = async () => {
        if (!canEdit) {
            alert('Only technicians and admins can add notes');
            return;
        }
                ...
                <div className="ticket-details-content">
                    <div className="ticket-header-section">
                        ...
                        <div className="ticket-badges">
                            <span className="badge status-badge" style={{ backgroundColor: getStatusColor(ticket.status) }}>
                                {ticket.status}
                            </span>
                            <span className="badge priority-badge" style={{ backgroundColor: getPriorityColor(ticket.priority) }}>
                                {ticket.priority}
                            </span>
                    ...
                    {/* 👇 Only show edit section for technicians/admins */}
                    {canEdit && (
                        <>
                            {isEditing ? (
                                <div className="edit-section">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input 
                                            ...
                                            placeholder="Technician name or 'Unassigned'"
                                        />
                                    </div>
                    ...
                    {/* 👇 Users only see updates, not internal notes */}
                    {isUser && ticket.notes && ticket.notes.length > 0 && (
                        <div className="notes-section">
                            <h3>Updates</h3>
                            <div className="notes-list">
                                {ticket.notes.map((note, index) => (
